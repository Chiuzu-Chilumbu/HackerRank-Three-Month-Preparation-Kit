"""
Challenge: Given an array of stick lengths, use  of them to construct a non-degenerate triangle 
...
def maximumPerimeterTriangle(sticks):
    ...
    # Iterate through the list of sticks, starting from the largest and checking every triplet.
    for i in range(len(sticks) - 2):
        # We check if the current stick and the next two sticks can form a triangle.
    ...
    # If no valid triangle is found after checking all possible triplets, return [-1].
    return [-1]

# Example usage
sticks = [1, 2, 3, 4, 5, 10]
print(maximumPerimeterTriangle(sticks))  # Should print the sides of the triangle with the maximum perimeter
